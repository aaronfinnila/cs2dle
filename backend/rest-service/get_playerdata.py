...
HEADERS = {
    "User-Agent": "cs2dle (aaronfinnilaa@gmail.com) updating player data",
...
def fetch_player_data(player_name):
    ...
    teams_to_fetch = team_history[-3:] if len(team_history) > 3 else team_history
    ...
    player_data = {
        ...
        "team": info["team"],
        "roles": info["roles"],
        "image": player_image, # player_image
        "team_history": team_history,
        "team_images": team_images # team_images
    }
    return player_data
